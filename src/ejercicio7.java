...
public class ejercicio7 {
    public static void main(String[] args){
        ...
        for (int cont = 0; apuestas.size() < 14; cont++) {
            apuestas.add(List.of(resultadosPosibles.get(rand.nextInt(2)),resultadosPosibles.get(rand.nextInt(2)),resultadosPosibles.get(rand.nextInt(2))));
            //Para cada apuesta, se crea una lista de 3 apuestas, hasta llegar a los 15 partidos
        }
        apuestas.add(List.of(resultadosPosiblesPleno.get(rand.nextInt(3)),resultadosPosiblesPleno.get(rand.nextInt(3)),resultadosPosiblesPleno.get(rand.nextInt(3))));
